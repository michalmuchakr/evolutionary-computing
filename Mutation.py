    ...
    def homogeneous_mutation(self):
        ...
        for i in self.member_after_crossing:
            ...
            if probability_of_mutation_tmp < self.probability_of_mutation:
                ...
                if first_value_before_change:
                    self.member_after_mutation.append([i[0][0:first_draw] + [False] + i[0][first_draw + 1:],
                                                       i[1][0:first_draw] + [False] + i[1][first_draw + 1:]])
                else:
                    self.member_after_mutation.append([i[0][0:first_draw] + [True] + i[0][first_draw + 1:],
                                                       i[1][0:first_draw] + [True] + i[1][first_draw + 1:]])
            else:
        ...
        for i in self.member_after_crossing:
            ...
            if probability_of_mutation_tmp < self.probability_of_mutation:
                ...
                if first_value_before_change == False:
                    self.member_after_mutation.append([i[0][0:first_draw - 1] + [True] + i[0][
                                                                                         first_draw:second_draw - 1] + [
                                                           True] + i[0][second_draw:],
                                                       i[1][0:first_draw - 1] + [True] + i[1][
                                                                                         first_draw:second_draw - 1] + [
                                                           True] + i[1][second_draw:]])
                else:
                    self.member_after_mutation.append([i[0][0:first_draw - 1] + [False] + i[0][
                                                                                          first_draw:second_draw - 1] + [
                                                           False] + i[0][second_draw:],
                                                       i[1][0:first_draw - 1] + [False] + i[1][
                                                                                          first_draw:second_draw - 1] + [
                                                           False] + i[1][second_draw:]])
