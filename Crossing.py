...
class Crossing:
    ...
    def __init__(self,list_of_object_gens,probability,size):
    ...
    def one_point_crossing(self,place_of_crossing,binary_value_for_the_draw_of_one,binary_value_for_the_draw_of_second):
        first_chromosome_first_chunk = binary_value_for_the_draw_of_one[0][0:place_of_crossing] + binary_value_for_the_draw_of_second[0][place_of_crossing:]
        first_chromosome_second_chunk = binary_value_for_the_draw_of_one[1][0:place_of_crossing] + binary_value_for_the_draw_of_second[1][place_of_crossing:]

        second_chromosome_first_chunk = binary_value_for_the_draw_of_second[0][0:place_of_crossing] + binary_value_for_the_draw_of_one[0][place_of_crossing:]
        second_chromosome_second_chunk = binary_value_for_the_draw_of_second[1][0:place_of_crossing] + binary_value_for_the_draw_of_one[1][place_of_crossing:]
    ...
    def two_point_crossing(self,first_half_of_the_crossing_site,second_half_of_the_crossing_site,binary_value_for_the_draw_of_one,binary_value_for_the_draw_of_second):
        first_chromosome_first_chunk = binary_value_for_the_draw_of_one[0][0:first_half_of_the_crossing_site] + \
                                       binary_value_for_the_draw_of_second[0][first_half_of_the_crossing_site:second_half_of_the_crossing_site]+binary_value_for_the_draw_of_one[0][second_half_of_the_crossing_site:]
        ...
        second_chromosome_first_chunk = binary_value_for_the_draw_of_second[0][0:first_half_of_the_crossing_site] + \
                                       binary_value_for_the_draw_of_one[0][first_half_of_the_crossing_site:second_half_of_the_crossing_site]+binary_value_for_the_draw_of_second[0][second_half_of_the_crossing_site:]
        second_chromosome_second_chunk = binary_value_for_the_draw_of_second[1][0:first_half_of_the_crossing_site] + \
                                       binary_value_for_the_draw_of_one[1][first_half_of_the_crossing_site:second_half_of_the_crossing_site]+binary_value_for_the_draw_of_second[1][second_half_of_the_crossing_site:]
    ...
    def three_point_crossing(self,first_half_of_the_crossing_site_three_point,second_half_of_the_crossing_site_three_point,third_half_of_the_crossing_site_three_point,binary_value_for_the_draw_of_one,binary_value_for_the_draw_of_second):
        first_chromosome_first_chunk = binary_value_for_the_draw_of_one[0][0:first_half_of_the_crossing_site_three_point] + \
                                       binary_value_for_the_draw_of_second[0][first_half_of_the_crossing_site_three_point:second_half_of_the_crossing_site_three_point]+binary_value_for_the_draw_of_one[0][second_half_of_the_crossing_site_three_point:third_half_of_the_crossing_site_three_point] + binary_value_for_the_draw_of_second[0][third_half_of_the_crossing_site_three_point:]
        first_chromosome_second_chunk = binary_value_for_the_draw_of_one[1][0:first_half_of_the_crossing_site_three_point] + \
                                       binary_value_for_the_draw_of_second[1][first_half_of_the_crossing_site_three_point:second_half_of_the_crossing_site_three_point]+binary_value_for_the_draw_of_one[1][second_half_of_the_crossing_site_three_point:third_half_of_the_crossing_site_three_point] + binary_value_for_the_draw_of_second[1][third_half_of_the_crossing_site_three_point:]
    ...
    def call_crossover_functions(self,which_function):
        while (len(self.member_after_crossing_one_point) != self.size):
